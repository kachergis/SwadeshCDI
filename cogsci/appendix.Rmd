...
2. For additional concepts, consider uni-lemmas that are frequently included on other CDIs, and especially focus on categories that are less well-represented on the Swadesh CDI: X, Y, and Z.
3. Do a study?
