...
We compared these correlations against a random baseline that simulated a methods of sampling items for a hypothetical new CDI form.
...
As reported above, the S-CDI yielded a mean total test information of 66085, while the random uni-lemmas baseline yielded a total test information of 64504. <!-- whereas the English uni-lemmas baseline yielded a total test information of 67866,
