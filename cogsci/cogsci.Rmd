...
The `r nrow(good_prod)` S-CDI items represented 21 of the 22 semantic categories present on the original American English CDI:WS form, with action words, animals, household, food/drink, body parts, and descriptive words being most prevalent, and connecting words, quantifiers, helping verbs, and articles being rare, and question words being unrepresented (but see extended S-CDI proposed below).
...
To mitigate the possibility of a ceiling effect, we propose also including an extension of 10 uni-lemmas, chosen from the original Swadesh (1971) list, which represent the under-represented categories on the S-CDI: 5 pronouns (_I, you, we, this, that_), 3 quantifiers (_all, many, not_), and 2 question words (_who, what_).
These uni-lemmas are included on a mean of 21 of the 26 forms, but are of greater cross-linguistic variability (mean $sd(d)=1.36$), and--importantly--difficulty (mean $d=0.84$).
...
```{r, out.width="\\linewidth", include=TRUE, fig.align="center", fig.cap=c("The 239 Swadesh CDI concepts by semantic category. Italicized items indicate concepts that are not included on the American English CDI:WS."), echo=FALSE}
