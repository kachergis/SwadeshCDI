...
We report analyses for twenty-four languages from Wordbank [@frank2017], comprising production data from CDI:WG vocabulary checklists.
...
```{r count-wg-participants, eval=F}
