...
However, there are many ways to select a random set of uni-lemmas to compare to, and each method could be argued to unfairly advantage or disadvantage the Swadesh list or the random baseline.
For example, if we simply selected 100 uni-lemmas uniformly at random, many of these uni-lemmas would not appear on some of the languages' CDI forms, and thus the actual 

It is also worth noting that beating a random subset of
