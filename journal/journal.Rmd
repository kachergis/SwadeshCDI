...
```{r}
xldf_clean <- xldf_clean %>% filter(!is.na(uni_lemma)) # 28529 out of 29874 have uni-lemmas defined 95.5%
...
gen_df <- get_sumscores_vs_swad(all_unis, gen_langs, good_prod$uni_lemma, form="WS") %>%
...
all_unis <- bind_rows(xldf, xldf_lowd)
#gen_xx_eng <- run_comparisons(all_unis, gen_langs, good_prod$uni_lemma, 
...
gen_xx_it <- run_comparisons(all_unis, gen_langs, good_prod$uni_lemma, 
                              rand_method="items", metrics=c("sumscore_cor"))

gen_xx_it_ext <- run_comparisons(all_unis, gen_langs, c(swad10, good_prod$uni_lemma), 
                              rand_method="items", metrics=c("sumscore_cor"))
