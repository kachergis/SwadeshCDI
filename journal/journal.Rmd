...
Short versions of the CDI:WS forms are also available [e.g., @Fenson2000], consisting of a set of around 100 items that generate scores that more strongly correlate with scores on the long forms, while retaining representation across a broad set of semantic categories.
...
Across the 26 IRT models for different CDI:WS forms, difficulty and discrimination parameters for a total of 25639 items were fitted.
