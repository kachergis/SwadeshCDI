...
for (lang in languages) {
  ...
  masked_resps <- lang_data$all_prod
  masked_resps[,non_swad_item_ids] = NA
  swad_fscores <- fscores(fitted$model, response.pattern=masked_resps)[,1] # maybe remove the rows with non-NA WG item responses?
  # Turkish: 3537 thetas; full_fscores[[lang]]$full_theta only has 3073 thetas...only for WS, maybe?
